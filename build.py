#!/usr/bin/env python3
"""
Poetry build script for mtobjects C extensions
"""
import os
import subprocess
import sys
...
def compile_c_extensions():
    """Compile C extensions for mtobjects package"""
    print("Building C extensions for mtobjects...")
...
def main():
    """Main build function"""
    try:
        success = compile_c_extensions()
        if not success:
            print("Failed to compile C extensions")
            sys.exit(1)
        else:
